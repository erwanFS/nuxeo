...
public class ITRemoteAutomationClientTCK {
    ...
    protected File newFile(String content) throws IOException {
        ...
        FileUtils.writeStringToFile(aFile, content, StandardCharsets.UTF_8);
        return aFile;
    }
    ...
    public void testComplexPropertiesWithJSON() throws Exception {
        ...
        fieldsDataAsJSon = org.apache.commons.io.FileUtils.readFileToString(fieldAsJsonFile, StandardCharsets.UTF_8);
